...
with (
    ...
    AIProjectClient(endpoint, credential, allow_preview=True) as client,
):
    definition = models.HostedAgentDefinition(
        ...
        protocol_versions=[
            models.ProtocolVersionRecord(protocol="responses", version="2.0.0")
        ],
    )
