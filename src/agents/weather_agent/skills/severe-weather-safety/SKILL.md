...
Apply these instructions whenever hazardous weather or an official alert is present.

## Instructions

- Prefer alerts from official meteorological and emergency authorities.
- Identify the event, affected location, severity, timing, and issuing authority.
- Clearly distinguish watches, warnings, and advisories.
- Put immediate protective actions before general forecast details.
- Never weaken, exaggerate, or contradict official guidance.
